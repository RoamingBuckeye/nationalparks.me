...
/**
 * Two-letter codes for the 50 states, DC, and the five inhabited territories
 * served by the National Park Service. Use the case value (e.g. `WY`) for
 * compact storage; `fullName()` for display.
 */
enum UsState: string
{
    case Alabama = 'AL';
